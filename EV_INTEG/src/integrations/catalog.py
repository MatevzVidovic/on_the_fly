...
_DECLARED_ENTRIES = {
    ...
    "ev_parc_enota_h_2025_danes": _entry("ev_parc_enota", "ev_parc_enota_h_2025_danes", "jn_parcela_enota_pk", ("id_parc_enota", "jn_rev_num"), "JN_PARC_ENOTA", "JN_PARC_ENOTA_PK_JNF_IX", "ev_parc_enota_h_2025_danes_kn.sql", "ev_parc_enota_h_2025_danes_lift.sql", from_2025=True, forbid_columns=("podatki",), check_page_keys=("jn_parcela_enota_pk",)),
