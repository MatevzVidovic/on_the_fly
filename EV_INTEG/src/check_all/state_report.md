...
- titles must all start with EV H; got ['EV - parc del H']; integration connection is not KN ORACLE; integration=8a9ed9a4-ae58-11f0-9f8c-169cd02558fe; connection='GURS ORCL'; titles=['EV - parc del H']; counts KN/target=16294681/14795300; target MAX(date_change)=2025-05-10T09:56:01.000000 != integration last_changed_datetime=2025-05-10T09:56:42.000000
...
- titles must all start with EV H; got ['EV Parcela H']; integration connection is not KN ORACLE; integration=c469d91a-ae56-11f0-84be-169cd02558fe; connection='GURS ORCL'; titles=['EV Parcela H']; counts KN/target=26483635/26016639; target MAX(date_change)=2025-05-10T09:56:01.000000 != integration last_changed_datetime=2025-05-10T09:56:55.000000
### ev_pe_dst_h

- references forbidden PODATKI column; titles must all start with EV H; got ['EV - PE DST  H']; integration connection is not KN ORACLE; integration=f5519202-ae65-11f0-adb7-169cd02558fe; connection='GURS ORCL'; titles=['EV - PE DST  H']; counts KN/target=209301/195225; target MAX(date_change)=2025-05-09T00:30:01.000000 != integration last_changed_datetime=2025-05-09T00:30:21.000000
### ev_pe_parc_h
...
- references forbidden PODATKI column; titles must all start with EV H; got ['EV - Posebna enota H']; integration connection is not KN ORACLE; integration=a75bfb06-ae69-11f0-941e-169cd02558fe; connection='GURS ORCL'; titles=['EV - Posebna enota H']; counts KN/target=44970/35768; target MAX(date_change)=2025-05-09T00:30:01.000000 != integration last_changed_datetime=2025-05-09T00:30:00.000000
### ev_prostor_h

- titles must all start with EV H; got ['EV - Prostor H']; integration connection is not KN ORACLE; integration=3d6e03ec-ae6e-11f0-bc34-169cd02558fe; connection='GURS ORCL'; titles=['EV - Prostor H']; counts KN/target=4645880/4551070; target MAX(date_change)=2025-05-10T09:56:01.000000 != integration last_changed_datetime=2025-05-10T09:57:41.000000
### ev_stavba_h

- titles must all start with EV H; got ['EV - Stavba H']; integration=39aa410c-beff-11f0-a601-5212cffe39ac; connection='KN ORACLE'; titles=['EV - Stavba H']; counts KN/target=3184228/2021464; 2324449 KN rows are newer than high-water mark
